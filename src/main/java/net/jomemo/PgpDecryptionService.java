...
//	private final ConcurrentHashMap<String, List<Message>> messages = new ConcurrentHashMap<String, List<Message>>();
//	private final ConcurrentHashMap<String, Boolean> decryptingMessages = new ConcurrentHashMap<String, Boolean>();
