...
//							Base64.decode(CryptoHelper.hexToString(kparts[2])), Integer.valueOf(kparts[3]));
...
//				}
//				byte[] serverFirstMessage = Base64.decode(challenge);
...
//				}
//
//				final String clientFinalMessageWithoutProof = "c=" + Base64.encode(
//						GS2_HEADER.getBytes(), true) + ",r=" + nonce;
...
//					Base64.encode(clientProof, true);
//				state = State.RESPONSE_SENT;
//				return Base64.encode(clientFinalMessage.getBytes(), true);
//			case RESPONSE_SENT:
//				final String clientCalculatedServerFinalMessage = "v=" +
//					Base64.encode(serverSignature, true);
//				if (challenge == null || !clientCalculatedServerFinalMessage.equals(new String(Base64.decode(challenge)))) {
