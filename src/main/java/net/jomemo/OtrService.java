...
//
//	private final Logger logger = LoggerFactory.getLogger(OtrService.class);
//
...
//			logger.debug(Config.LOGTAG,account.getJid().toBareJid()+": smp in invalid session "+id.toString());
//		}
//	}
//
//	@Override
...
//		logger.debug(Config.LOGTAG,"show error");
//	}
//
//	@Override
...
//		logger.debug(Config.LOGTAG,"unreadable message received");
...
//				logger.debug(Config.LOGTAG,packet.toString());
//				logger.debug(Config.LOGTAG,account.getJid().toBareJid().toString()
...
//		logger.debug(Config.LOGTAG,"OtrService.verify("+id.toString()+","+fingerprint+","+String.valueOf(approved)+")");
//		try {
//			final Jid jid = Jid.fromSessionID(id);
//			Conversation conversation = this.mXmppConnectionService.find(this.account,jid);
//			if (conversation!=null) {
